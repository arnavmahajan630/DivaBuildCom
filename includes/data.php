...
$featuredProjects = [
    [
        ...
        'detail_copy' => 'A flagship 12-story commercial landmark in Borivali. This project defines modern workspace efficiency with integrated smart building technologies and a high-performance curtain wall system for optimal thermal control.',
        'specs' => [
            ['icon' => 'foundation', 'label' => 'Foundation', 'value' => 'Raft Foundation (2.5m thick)'],
            ['icon' => 'structure', 'label' => 'Structure', 'value' => 'M40 Grade RCC / Fe500D'],
            ['icon' => 'safety', 'label' => 'Safety Code', 'value' => 'Seismic Zone III Compliant'],
            ['icon' => 'sustainability', 'label' => 'Sustainability', 'value' => 'IGBC Gold Certified'],
        ],
        ...
        'units' => [
            ...
            ['type' => 'Service Core', 'size' => '1,200 sq.ft. Centralized'],
        ],
        'zoning_title' => 'Functional Zoning',
        'zoning_copy' => 'The core is centralized to allow 360-degree perimeter glazing. Zoning separates high-traffic lobbies from quiet executive wings, with dedicated service corridors for maintenance access.',
    ],
    [
        ...
        'detail_copy' => 'A 22-story premium residential tower in Kandivali West. Designed for families seeking suburban comfort with urban connectivity, featuring earthquake-resistant construction, open-plan living, and lush podium gardens.',
        'specs' => [
            ['icon' => 'foundation', 'label' => 'Foundation', 'value' => 'Pile Foundation (18m deep)'],
            ['icon' => 'structure', 'label' => 'Structure', 'value' => 'M35 Grade RCC / Fe500D'],
            ['icon' => 'safety', 'label' => 'Safety Code', 'value' => 'Seismic Zone III Compliant'],
            ['icon' => 'sustainability', 'label' => 'Sustainability', 'value' => 'GRIHA 4-Star Rated'],
        ],
        ...
        'units' => [
            ...
            ['type' => 'Penthouse', 'size' => '2,800 sq.ft. Duplex'],
        ],
        'zoning_title' => 'Functional Zoning',
        'zoning_copy' => 'Living and bedroom zones are separated by the service core for acoustic privacy. Each unit enjoys cross-ventilation with the building oriented along the prevailing wind axis.',
    ],
    [
        ...
        'detail_copy' => 'A high-capacity logistics and warehousing complex in Malad East. Engineered for heavy-duty industrial operations with wide-span steel structures, VDF flooring, and rapid site delivery across 2.5 acres.',
        'specs' => [
            ['icon' => 'foundation', 'label' => 'Foundation', 'value' => 'Mat Foundation (1.8m thick)'],
            ['icon' => 'structure', 'label' => 'Structure', 'value' => 'Pre-Engineered Steel / M30 RCC'],
            ['icon' => 'safety', 'label' => 'Safety Code', 'value' => 'NBC 2016 Compliant'],
            ['icon' => 'sustainability', 'label' => 'Sustainability', 'value' => 'LEED Silver Certified'],
        ],
        ...
        'units' => [
            ...
            ['type' => 'Office Block', 'size' => '3,500 sq.ft. Mezzanine'],
        ],
        'zoning_title' => 'Functional Zoning',
        'zoning_copy' => 'Segregated inbound and outbound zones with dedicated truck movement corridors. Office and admin blocks are isolated from warehouse operations to reduce noise and dust exposure.',
    ],
];
